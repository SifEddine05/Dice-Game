...
public void genererImage() {
    ...
    BufferedReader file = p.getFileimg();
    ...
    try {
        ...
        NumImg.setText("Question " + tok.nextToken());
        // System.out.println("le numero de la question est :" + tok.nextToken());
        Qes.setText("la question est :" + tok.nextToken());
    ...
    System.out.println("Le n est:"+n);
        File file1 = new File("src/main/resources/Images/Img"+n+".png") ;
        img1.setImage(new Image(file1.toURI().toString()));
    //System.out.println("Le n est:"+n);
    File file2 = new File("src/main/resources/Images/Img" + (n+1) + ".png") ;
    img2.setImage(new Image(file2.toURI().toString()));
    File file3 = new File("src/main/resources/Images/Img" + (n+2) + ".png") ;
    img3.setImage(new Image(file3.toURI().toString()));
    File file4 = new File("src/main/resources/Images/Img" + (n+3) + ".png") ;
