...
class Grille 
{
    ...
    public void generer_plateau_randomly()//generer un palteau aleatoire apres sa creation on utilisant des permutations 
    {
...
class Partie
{
    ...
    private int num_case_act ;
    private Joeur joeur ;
    static long meilleure_score ;
    private De dee ;
    public void lancer_De()
    {
        System.out.println("lancer le D1 "+dee.De1());
        System.out.println("lancer le D2 "+dee.De2());
